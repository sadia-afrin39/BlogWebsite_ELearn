...
?>
<?php
    $slider = mysqli_real_escape_string($db->link,$_GET['sliderid']);
                        ...
                        if(!empty($file_name)){
                          if ($file_size >1048567) {
                            ...
                            $query ="UPDATE tbl_slider 
                                    SET title='$title', image='$uploaded'
                                    WHERE id = '$sliderid';"; 
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <img src="upload/slider/<?php echo $sliderresult['image']; ?>" height="100px" width="250px"/><br/>
