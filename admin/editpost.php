              ...
              if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $uploaded= $unique_image;
                  if($title == "" || $cat == ""|| $body == ""|| $tags == ""|| $author == ""){
                        ...
                        if(!empty($file_name)){
                          if ($file_size >1048567) {
                            ...
                            $query ="UPDATE tbl_post 
                                    SET cat='$cat', title='$title', body='$body', image='$uploaded', author='$author', tags='$tags', userid = '$userid'
                                    WHERE id = '$postid';"; 
                      ...
                      $query ="UPDATE tbl_post 
                                SET cat='$cat', title='$title', body='$body', author='$author', tags='$tags', userid = '$userid'
                                WHERE id = '$postid';"; 
                        $updated_rows = $db->update($query);
                        if ($updated_rows) {
                            echo "<span class='success'>Post Updated Successfully!!</span>";
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <img src="upload/<?php echo $postresult['image']; ?>" height="80px" width="200px"/><br/>
