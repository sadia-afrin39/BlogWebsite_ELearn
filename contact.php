 ...
 <?php 
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(empty($fname)){
            ...
            $errore = "Email Address must not be empty! ";
		...
		<div class="maincontent clear">
			...
			<form action="" method="post">
				...
				<tr>
					<td>First Name:</td>
					<td>
                       <?php if(isset($errorf)){echo "<span class='cuserror'>$errorf</span>"; }?>
				...
				<tr>
					<td>Last Name:</td>
					<td>
                       <?php if(isset($errorl)){echo "<span class='cuserror'>$errorl</span>"; }?>
				...
				<tr>
					<td>Email Address:</td>
					<td>
                        <?php if(isset($errore)){echo "<span class='cuserror'>$errore</span>"; }?>
				...
				<tr>
					<td>Message:</td>
					<td>
                        <?php if(isset($errorb)){echo "<span class='cuserror'>$errorb</span>"; }?>
